...
public class ShareListActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(br.unb.mobileMedia.MMPlaylist_and_Share.R.layout.activity_share_list);
		
		btnTopArtists = (Button)findViewById(br.unb.mobileMedia.MMPlaylist_and_Share.R.id.btn_top_artists);
		btnTopSongs = (Button)findViewById(br.unb.mobileMedia.MMPlaylist_and_Share.R.id.btn_top_songs);
		btnShareApp = (Button)findViewById(br.unb.mobileMedia.MMPlaylist_and_Share.R.id.btn_share_app);
/*		btTopArtists.setText(br.unb.mobileMedia.MMPlaylist_and_Share.R.string.btn_top_artists);
		btTopArtists.setTextColor(Color.WHITE);
		btTopArtists.setBackgroundResource(br.unb.mobileMedia.MMPlaylist_and_Share.R.drawable.button_gradient);
...
//		Log.d(getLocalClassName(), "QUERENDO-TE");
		...
		adapterTopArtists.addProvider(Provider.FACEBOOK, br.unb.mobileMedia.MMPlaylist_and_Share.R.drawable.facebook);
		adapterTopArtists.addProvider(Provider.TWITTER, br.unb.mobileMedia.MMPlaylist_and_Share.R.drawable.twitter);
...
*/
	...
	private void configAdapter(SocialAuthAdapter adapter, String conteudo, Button btn){
		...
		adapter.addProvider(Provider.FACEBOOK, br.unb.mobileMedia.MMPlaylist_and_Share.R.drawable.facebook);
		adapter.addProvider(Provider.TWITTER, br.unb.mobileMedia.MMPlaylist_and_Share.R.drawable.twitter);

package br.unb.mobileMedia.MMUnBFull.core.view;
...
public class ShareListActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(br.unb.mobileMedia.MMUnBFull.R.layout.activity_share_list);
		
		btnTopArtists = (Button)findViewById(br.unb.mobileMedia.MMUnBFull.R.id.btn_top_artists);
		btnTopSongs = (Button)findViewById(br.unb.mobileMedia.MMUnBFull.R.id.btn_top_songs);
		btnShareApp = (Button)findViewById(br.unb.mobileMedia.MMUnBFull.R.id.btn_share_app);
/*		btTopArtists.setText(br.unb.mobileMedia.MMUnBFull.R.string.btn_top_artists);
		btTopArtists.setTextColor(Color.WHITE);
		btTopArtists.setBackgroundResource(br.unb.mobileMedia.MMUnBFull.R.drawable.button_gradient);
...
//		Log.d(getLocalClassName(), "QUERENDO-TE");
		...
		adapterTopArtists.addProvider(Provider.FACEBOOK, br.unb.mobileMedia.MMUnBFull.R.drawable.facebook);
		adapterTopArtists.addProvider(Provider.TWITTER, br.unb.mobileMedia.MMUnBFull.R.drawable.twitter);
...
*/
	...
	private void configAdapter(SocialAuthAdapter adapter, String conteudo, Button btn){
		...
		adapter.addProvider(Provider.FACEBOOK, br.unb.mobileMedia.MMUnBFull.R.drawable.facebook);
		adapter.addProvider(Provider.TWITTER, br.unb.mobileMedia.MMUnBFull.R.drawable.twitter);
